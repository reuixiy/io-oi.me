...
最后，如何使用这个主题？如何自定义？如何使用 Hugo？如何从 Hexo 迁移到 Hugo？如何通过 Netlify 实现持续集成？主题的文档仍在码字中，我也将陆续写出几篇通俗易懂的教程，希望能够普及下 Hugo。当然，如果你比较心急，想马上探索 Hugo 和 MemE，可以自行去查看我在 GitHub 上的 [meme-test](https://github.com/reuixiy/meme-test) 和 [io-oi.me](https://github.com/reuixiy/io-oi.me) 这两个仓库，以作参考。
